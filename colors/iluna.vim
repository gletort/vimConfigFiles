 ...
 " Delimiters
 hi Delimiter      guibg=#ffd7af   guifg=fg       ctermbg=bg   ctermfg=36
 ...
 hi Include    guibg=bg   guifg=#af5f00   ctermbg=bg ctermfg=55
 hi Statement   guibg=bg    guifg=#00af00      ctermbg=bg  ctermfg=31
 hi Conditional guibg=bg    guifg=#870000      ctermbg=bg  ctermfg=61
 hi Repeat      guibg=bg    guifg=#870000      ctermbg=bg   ctermfg=69
 hi Type       guibg=bg   guifg=#005f00      ctermbg=bg  ctermfg=130
 hi Structure      guibg=bg   guifg=#af5f00      ctermbg=bg  ctermfg=140
 hi Exception   guibg=bg    guifg=#5f00af      ctermbg=bg  ctermfg=124
 hi Special	 guibg=bg   guifg=fg   ctermbg=bg     ctermfg=136
 hi StorageClass   guibg=bg   guifg=#af5f00      ctermbg=bg  ctermfg=170

 hi Constant    guibg=bg    guifg=#5fd75f        ctermbg=bg   ctermfg=215
 hi Number      guibg=bg    guifg=#5fd75f      ctermbg=bg  ctermfg=214
 hi Float       guibg=bg    guifg=#5fd75f      ctermbg=bg   ctermfg=214
 hi String      guibg=bg    guifg=#af0000    ctermbg=bg  ctermfg=179
 hi Character   guibg=bg    guifg=#00af00      ctermbg=bg  ctermfg=130
 hi Boolean     guibg=bg    guifg=#5fd75f  gui=none    ctermbg=bg   ctermfg=77
 hi SpecialChar    guibg=#ffd7af   guifg=#000000     ctermbg=bg   ctermfg=101
 ...
 hi Function    guibg=bg    guifg=#870000      ctermbg=bg  ctermfg=98
 ...
 hi Tag        guibg=bg   guifg=#5faf87      ctermbg=bg   ctermfg=65
...
" Save color scheme name
 let g:colors_name = "iluna"
 let colors_name   = "iluna"
